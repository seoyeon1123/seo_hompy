...
const NavComponent = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-row justify-center items-center lg:gap-6  gap-4 py-4 bg-opacity-5 backdrop-blur-md rounded-full *:text-white font-bold lg:w-[400px] w-[350px] mx-auto shadow-md">
