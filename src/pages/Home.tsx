        ...
        <div className="flex flex-col items-center justify-center gap-5 h-screen bg-[#16423C] text-white relative">
          {firstTextVisible && (
            <motion.div
              ...
              className="text-center absolute top-[140px] sm:top-20"
              onAnimationComplete={() => setSecondTextVisible(true)}
            >
              <h1 className="text-9xl sm:text-7xl font-bold text-[#6A9C89] relative z-0 text-shadow-lg sm:-top-6">
                Front - End
              </h1>
          ...
          <motion.img
            ...
            alt="프로필"
            width={300}
            className="rounded-full shadow-xl border-4 border-[#387478] mb-6 sm:size-60 sm:top-48"
