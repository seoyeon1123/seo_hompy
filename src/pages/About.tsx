...
const About = () => {
  ...
  return (
    <div className="flex flex-col pt-14 h-svh sm:h-full bg-[#E9EFEC] p-6 md:p-10 gap-8 ">
      <motion.h1
      ...
      {firstVisible && (
        <div className="flex flex-row sm:flex-col sm:gap-6 gap-8 items-center mb-12 mt-8">
          <motion.div
