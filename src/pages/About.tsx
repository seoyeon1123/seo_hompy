...
const About = () => {
  ...
  return (
    <div ref={aboutRef} className="flex flex-col pt-14 h-svh sm:h-full bg-[#E9EFEC] p-6 md:p-10 gap-8">
      {/* About Me Header */}
      <motion.h1
      ...
      {secondVisible && (
        <motion.div
          className="flex flex-row sm:flex-col sm:gap-6 gap-8 items-center mb-12"
          initial="hidden"
          animate="visible"
      ...
      {/* SkillfulSection Component */}
      {skillSectionVisible && <SkillfulSection />}
    </div>
  );
};
